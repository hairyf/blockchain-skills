...
2. Call the [simulate-transaction](https://docs.straitsx.com/v1-CARDS/reference/simulate-transaction) endpoint with `type`, `amount`, optional `currency`, and optional merchant fields.
