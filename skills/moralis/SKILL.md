---
name: moralis
description: Moralis — Web3 Data API, Streams, Auth API, and Cortex (AI/MCP) for EVM and Solana.
metadata:
  author: hairy
  version: "2026.2.9"
  source: Generated from https://github.com/MoralisWeb3/docs
---
...
- [Moralis GitHub](https://github.com/MoralisWeb3/docs)
- [Cortex MCP Server](https://www.npmjs.com/package/@moralisweb3/api-mcp-server)
